  ...
  <div class="d-flex bg-white">
    <v-Form ref="form" @submit.prevent="onSubmit">
      ...
      <div class="w-100 d-flex flex-column flex-md-row ga-1">
        ...
        <v-btn class="flex-grow-1" color="success" @click="accepted">Akceptuj formularz</v-btn>
        <v-btn class="flex-grow-1" color="warning" @click="notAccepted">Wycofaj formularz</v-btn>
