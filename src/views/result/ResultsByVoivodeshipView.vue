  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: 'Miejscowość', key: 'schoolClass.school.city' },
        { title: 'Województwo', key: 'schoolClass.school.voivodeship.name' },
        { title: 'Region', key: 'schoolClass.school.region.name' },
      ],
    }
  },
  beforeMount() {
...
<template>
  <v-data-table v-model:items-per-page="itemsPerPage" :headers="headers" :items="tasks" item-value="name" class="elevation-1">
  </v-data-table>
</template>
